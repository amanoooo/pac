...
function test() {
    console.log(FindProxyForURL('https://3pp.stg.starbucks.com.cn/xx',));
    console.log(FindProxyForURL('http://3pp.stg.starbucks.com.cn/xx',));
    console.log(FindProxyForURL('http://3pp.stg.starbucks.com.cn',));
    console.log(FindProxyForURL('https://bff.stg.starbucks.com.cn',));
    console.log(FindProxyForURL('http://bff.stg.starbucks.com.cn',));
}
